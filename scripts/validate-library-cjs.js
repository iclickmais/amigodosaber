...
const matchTotal = content.match(/export const totalLibrarySize = (\d+);/);
if (!matchTotal || parseInt(matchTotal[1], 10) !== 10000) {
  throw new Error(`Total library size mismatch or missing: ${matchTotal ? matchTotal[1] : 'none'}`);
}
